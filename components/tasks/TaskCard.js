...
export default function TaskCard({ task, onToggle, onDelete }) {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", padding: "0.6rem 0.75rem", background: "var(--bg)", borderRadius: 8, border: "1px solid var(--border)", marginBottom: "0.375rem", opacity: task.done ? 0.65 : 1 }}>
      ...
      <span style={{ fontSize: "0.65rem", fontWeight: 700, padding: "0.15rem 0.5rem", borderRadius: 4, background: p.bg, color: p.color, flexShrink: 0 }}>{p.label}</span>
